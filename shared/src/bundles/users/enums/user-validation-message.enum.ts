...
const UserValidationMessage = {
    ...
    FULLNAME_WRONG:
        'Fullname must only consist of letters and spaces',
    NICKNAME_LENGTH: `Nickname should have from ${NICKNAME.MIN_LENGTH} to ${NICKNAME.MAX_LENGTH} characters.`,
    NICKNAME_WRONG:
        'Nickname should consist of letters, and numbers, no special characters, spaces, emoji are allowed',
    ...
    LOCATION_WRONG: 'Location should be in format City, Country. No special characters, numbers, or emoji are allowed.',
