...
const Radio = <T extends FieldValues>({
    ...
    > = {
        ...
        [RadioType.CARD]: {
            ...
            inputChecked: '',
            label: 'sm:py-1.5 font-bold text-lm-grey-200 bg-lm-black-100 table-cell h-37 cursor-pointer px-5 py-2.5 text-center align-middle text-prebase whitespace-nowrap ',
            labelChecked:
