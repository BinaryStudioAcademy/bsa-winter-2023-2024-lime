...
const DownloadBanner = (): JSX.Element | null => {
    ...
    return (
        <div className="bg-buttonSecondary text-primary fixed left-0 top-0 z-50 flex h-24 w-full items-center justify-evenly rounded-b-lg p-4 text-center shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] lg:xl:hidden">
            <button
                onClick={closeBanner}
