...
const classes = {
    base: 'transition-bg rounded-34 flex w-[120px] cursor-pointer items-center justify-center self-stretch px-4 py-3 text-center duration-300 sm:w-[140px] md:w-[160px] lg:w-[180px]',
    active: 'bg-tertiary',
    background:
