...
const AchievementCard: React.FC<Properties> = ({
    ...
    return (
        <div className="bg-lm-black-100 flex h-[4.125rem] justify-between rounded-lg p-4 lg:w-80">
            ...
            <div className="bg-lm-grey-500 flex hidden items-center justify-center rounded-full px-2 py-1 xl:block">
