...
const Auth: React.FC = () => {
    ...
    const classes = {
        base: 'relative flex flex-col flex-1 bg-lm-black-200 mx-[1rem] my-[1.125rem] rounded-[2.75rem] lg:flex-none lg:w-[45rem] text-lm-black-100 dark:text-white bg-lm-grey-200 dark:bg-lm-black-200',
